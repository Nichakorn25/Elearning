...
func SetupDatabase() {
	...
	db.FirstOrCreate(&day, entity.DayofWeek{DayName: "Monday"})
	...
	db.FirstOrCreate(&semester, entity.Semester{Year: 2024, Term: 1})
	
	category := entity.Category{
		Model:        gorm.Model{ID: 1},
		CategoryName: "Sample Category",
	}
	db.FirstOrCreate(&category, entity.Category{CategoryName: "Sample Category"})
	...
	db.FirstOrCreate(&course, entity.Course{CourseName: "Sample Course"})
	// เพิ่ม CartStatus
